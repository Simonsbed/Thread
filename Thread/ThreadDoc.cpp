...
// ThreadDoc.cpp: CThreadDoc 클래스의 구현
//
...
CThreadDoc::CThreadDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CThreadDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CThreadDoc::InitializeSearchContent()
{
...
void CThreadDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
