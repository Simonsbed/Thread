...
// Thread.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CThreadApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CThreadApp::OnAppAbout)
...
CThreadApp::CThreadApp() noexcept
{
	...
	SetAppID(_T("Thread.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CThreadApp 개체입니다.
